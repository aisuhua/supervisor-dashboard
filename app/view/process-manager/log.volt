<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-right">
            {% if running %}
            <a class="btn btn-primary btn-sm navbar-btn" id="refresh" href="javascript:void(0);" data-href="/process-manager/tail?server_id={{ server.id }}&group={{ group }}&name={{ name }}&stderr={{ stderr }}" data-nopjax>自动刷新</a>
            {% endif %}
